...
public class IntroMessage : MonoBehaviour
{
    ...
    public string message =
        "[IA LOG] Collectez de l'eau, des graines et de l'engrais pour restaurer la terre.\n" +
        "[IA LOG] Interragisez avec moi (E) lorsque vous êtes prêt. \n" +
        "[IA LOG] Utilise les flèches du clavier pour te déplacer";
